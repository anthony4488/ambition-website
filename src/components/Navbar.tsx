...
// Focused landing pages: logo only, no nav. /apply is deliberately NOT here, // paid visitors need to be able to validate the business without leaving.
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex items-center justify-between h-[84px] sm:h-24">
          <Link href="/" className="flex items-center gap-3 group">
            <span className={"inline-block rounded-2xl transition-all " + (scrolled ? "" : "bg-white p-2.5 shadow-md")}>
            <Image
              src="/logo.png"
